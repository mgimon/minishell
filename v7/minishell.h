...
/*   Updated: 2024/11/19 20:28:25 by mgimon-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char					*expand_var(const char *input, t_general *info);
...
// utils_23.c
void					process_and_write_line(char *buffer, t_heredoc *tmp_hdoc, t_general *info);
...
char					**replace_pwd_in_env(char **env, int env_size, int pwd_index, char *new_pwd);
int					env_size(char **env);
void					cleanup_and_replace_env(t_section *current, char **split_pwd, char **new_env);
