...
/*   Updated: 2024/11/08 21:00:39 by mgimon-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct {
    ...
    AllocatedBlock allocated_blocks[16000]; // Ajusta el tamaño según sea necesario
    int block_count;
    int total_allocs;
    int total_frees;
} MemoryManager;
...
// utils_executor.c
void    handle_child_process(t_section *current, int prev_fd, int pipefd[2], int statuspipe[2]);
